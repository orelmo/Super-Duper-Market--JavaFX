...
public class UIAdapter implements StoresAdder, ItemsAdder {
    private VBox storesVbox;
    private VBox itemsVbox;
    private ToggleGroup storesGroup;
    private ToggleGroup itemsGroup;
    private SDMAddItemToStorePageController controller;

    public UIAdapter(VBox storesVbox, VBox itemsVbox, SDMAddItemToStorePageController controller){
